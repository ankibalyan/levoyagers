<div class="modal-header">
	<h2>Sign Up</h2>
    <p><a href="login">Login </a> or <a href="forget">Forget Password </a> </p>
</div>
...
<?php } ?>
	<?php $attributes = array('name'=>'register_form', 'class' => 'register_form', 'id' => 'register_form'); ?>
	<?php echo form_open('admin/user/register',$attributes); ?>
    	<?php echo form_fieldset('Register with your credentials'); ?>
